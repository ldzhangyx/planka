...
export default {
  ...
  translation: {
    common: {
      ...
      archiveBoard_title: '归档面板',
      archivedBoards: '已归档面板',
      ...
      areYouSureYouWantToArchiveThisBoard: '确认要归档此面板吗？',
      ...
      areYouSureYouWantToRestoreThisBoard: '确认要恢复此面板吗？',
